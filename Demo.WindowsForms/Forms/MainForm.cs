...
using GMap.NET.MapProviders.LocalTileMap_google;
    ...
    public partial class MainForm : Form
    {
        ...
        public MainForm()
        {
            ...
            if (!GMapControl.IsDesignerHosted)
            {
                ...
                MainMap.MapProvider = LocalTileMapProvider.Instance;
                ...
                for (int i = (int)MainMap.Zoom; i <= MainMap.MaxZoom; i++)
                {
                    ...
                    if (res == DialogResult.Yes)
                    {
                        using (TilePrefetcher obj = new TilePrefetcher())
                        {
                            ...
                            obj.Start(area, i, MainMap.MapProvider, MainMap.Manager.Mode == AccessMode.CacheOnly ? 0 : 100, 0);
